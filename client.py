...
def leftbBoard():
    ...
    for box in range(0,11):
        if box==0:
            boxLabel=Label(gameWindow, width=2, height=1,borderwidth=0,bg="purple", font=("Helvetica", 30))
...
def gameWindow():
    ...
    finishingBox()
    global rollButton
    rollButton=Button(gameWindow, text="rollDice", bg="white", width=20, height=5, command=rollDice, font=("Chalkboard SE", 15))
